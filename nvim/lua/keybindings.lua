...
keymap('n', '<leader>i', ':Telescope lsp_references<CR>', opts)
keymap('n', '<leader>I', ':Telescope lsp_definitions<CR>', opts)
...
keymap('n', '<leader>e', ':VimuxRunCommand("source .venv/bin/activate; python " . bufname("%"))<CR>', opts)
